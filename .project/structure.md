...
- `src/app.jsx`: route selection (About is the default landing page), theme/language state, and the app shell.
...
- `src/posts.js`: blog post metadata (POSTS); single source of truth shared by `src/data.js` (browser) and the RSS feed generator.
