...
- **記事表示**：目次、関連記事、Shiki によるコードハイライト、コードのコピー操作、スライドと動画の埋め込みを備えます。
...
`|` とその直後の半角空白1つは表示から取り除き、行の残りは通常の Markdown として扱います。
...
スライドや動画はリーフディレクティブ `::embed` で埋め込みます。
