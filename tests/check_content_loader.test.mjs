...
test("relatedPostIds_ordersBySharedTagsThenDate_andToleratesPartialInput", () => {
  const posts = [
...
test("loadSiteContent_resolvesPostsBodiesTagsAndAboutContent", () => {
...
test("postIdPattern_acceptsGeneratedDirectoryNamesOnly", () => {
...
test("contentWatchFiles_returnsExistingTrackedContentFiles", () => {
  const root = rootDir();
